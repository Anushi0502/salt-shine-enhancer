...
const Hero = () => {
  return (
    <section className="salt-container my-8 grid grid-cols-[1.35fr_0.65fr] gap-4 max-lg:grid-cols-1 animate-rise">
      {/* Main hero card */}
      <div
      ...
      <div className="min-h-[610px] max-lg:min-h-[auto] rounded-xl border border-salt-line bg-gradient-to-b from-[hsl(28_60%_94%)] via-[hsl(26_45%_90%)] to-[hsl(24_40%_87%)] shadow-soft grid grid-rows-[auto_1fr_auto] overflow-hidden">
        ...
        <div className="p-4 grid gap-2.5 content-center">
          {[
            ...
            <a
              key={item}
              href="#"
              className="border border-foreground/10 rounded-full bg-[rgba(255,255,255,0.74)] px-3.5 py-2.5 flex justify-between items-center text-sm transition-all duration-200 hover:translate-x-1 hover:border-foreground/25 hover:bg-card"
            >
              {item}
        ...
        <div className="p-4 border-t border-dashed border-foreground/20 grid grid-cols-3 gap-2.5">
          {[
            ...
            { val: "24/7", label: "Storefront" },
            { val: "Secure", label: "Checkout" },
          ].map((s) => (
